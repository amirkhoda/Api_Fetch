        ...
        <div>
            <Form className="form">
                ...
                <div style={{ marginTop: "1rem" }}>
                    ...
                    <input style={{ borderRadius: "10px", marginLeft: "8px" }} size="15" placeholder="Enter Your Name" />
                    {/* lastName */}
                    <label className="text-white" style={{ fontSize: "16px", marginLeft: "1rem" }}>LastName : </label>
                    <input style={{ borderRadius: "10px", marginLeft: "8px" }} size="15" placeholder="Enter Your LastName" />
                </div>

                {/* email */}
                <div style={{ marginTop: "2rem" }}>
                    <label className="text-white" style={{ fontSize: "16px" }}>Email : </label>
                    <input style={{ borderRadius: "10px", marginLeft: "12px" }} size="15" placeholder="Enter Your Email" />
                    {/* phone */}
                    <label className="text-white" style={{ fontSize: "16px", marginLeft: "2rem" }}>Phone : </label>
                    <input style={{ borderRadius: "10px", marginLeft: "15px" }} size="15" placeholder="Enter Your phone: +98" />
                </div>
                {/* username */}
                <div style={{ marginTop: "2rem" }}>
                    <label className="text-white" style={{ fontSize: "16px" }}>UserName : </label>
                    <input style={{ borderRadius: "10px", marginLeft: "12px" }} size="20"  placeholder="UserName" />

                    <label  className="text-white" style={{marginLeft:"1.7rem"}}>Gender:</label>
                    <select style={{ height: "2rem", marginLeft: "1rem",borderRadius:"10px" }}>
                ...
                <div style={{ marginTop: "2rem" }}>
                    ...
                    <input style={{ borderRadius: "10px", marginLeft: "15px" }} size="20" placeholder="Password" />

                    <label className="text-white" style={{marginLeft:"2.7rem"}} >Age:</label>
                    <select style={{ height: "2rem", marginLeft: "1rem" ,borderRadius:"10px"}}  placeholder="Age">
